...
🔨회고 : 회고랄 것도 없는 것 같다, 옛날 풀이를 보니 방식은 비슷한 것 같고 코드 컨벤션이 조금 차이가 난다
프로그래머스 베스트 풀이를 보니 짧은 라인의 풀이 같은게 여전히 랭킹권인데 사실 고민이 된다.
저렇게 한 줄 짜리 풀이가 파이썬스럽다는게 사실 뭔지 모르겠고 난 그냥 한줄 한줄 설명이 되게 하는게 좋은 것 같다 
