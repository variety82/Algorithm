...
🎃회고
로직은 굉장히 단순하다, 3진법이랑 똑같은데 단지 0을 4로 변환하여 처리를 하여야 한다
처음엔 주어진 n에 대하여 3진법으로 변환 후 0을 4로 변환 & 4로 변환된 숫자에대해 앞자리 내림 이런과정을 거치니 효율성, 정확성 모두 문제가 생겼다
처음부터 나눌 때 [1,2,4] 에 대한 인덱스로 지정해주면 편하다...
멍청....
..ㅡ.,.,/ㅁ,ㅍ/ㅋ,.흑흑
